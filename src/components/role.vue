  ...
  <div>
    ...
    <div style="margin-top: 15px">
      ...
      <el-row style="margin-top: 10px">
        <el-button type="primary" @click="dialogFormVisible=true" v-if="hasPerm('role:edit')">角色新增</el-button>
      </el-row>
      ...
      <el-pagination :page-size="10" :current-page.sync="pageNum" layout="total, prev, pager, next" @current-change="queryRole('page')" :total="total">
      </el-pagination>
      ...
      <el-dialog title="权限分配" :visible.sync="permDialogFormVisible" :close-on-press-escape="false" @close="resetDialog(2)" :close-on-click-modal="false" width="30%">
        <el-tree :data="permList" show-checkbox node-key="id" ref="tree" :default-expanded-keys="role.pPermIds" highlight-current :props="defaultProps">
        </el-tree>
        <div slot="footer" class="dialog-footer">
