<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path:'/index/essayinfo'}">接口服务管理</el-breadcrumb-item>
      ...
      <el-row>
        <el-col :span="14">
          <el-card class="box-card">
            <div slot="header" class="clearfix">
              <el-row>
                <el-col :span="4">
                  <img height="70" width="70" style="border-radius: 35px" :src="imgUrl+'/'+essay.user.avatar">
                </el-col>
                <el-col :span="12">
        ...
        <el-col :span="10">
          <el-card class="box-card">
            ...
            <div>
              <el-table :show-header="false" :data="tableData" v-loading="loading" style="width: 100%">
                ...
                <el-table-column>
                  <template slot-scope="scope">
                    <div>{{scope.row.user.nickname}}&nbsp;&nbsp;<span style="font-size: 10px;color: chocolate">{{scope.row.createTime | formatDate}}</span></div>
                    <div>{{scope.row.content}}</div>
                  </template>
                </el-table-column>
              </el-table>

              <el-pagination :page-size="10" layout="total, prev, pager, next" :current-page.sync="pageNum" @current-change="queryComment" :total="total">
              </el-pagination>
            </div>
